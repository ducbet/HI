...
import com.example.tmd.hi_20172.activity.SprayTreeActivity;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public static final int REQUEST_TREE_SPRAY_ACT = 126;
    ...
    private void addTrees() {
        ...
        tempTree.add(new Tree(new LatLng(21.004730, 105.844619), new int[]{R.mipmap.ic_01_do, R.mipmap.ic_01_ca, R.mipmap.ic_01_xa}, "Rau muống", Tree.RED, R.drawable.rau_muong, "Tưới đều xung quanh gốc, chú ý không tưới quá mạnh tay."));
        tempTree.add(new Tree(new LatLng(21.004433, 105.846986), new int[]{R.mipmap.ic_02_do, R.mipmap.ic_02_ca, R.mipmap.ic_02_xa}, "Hoa hồng", Tree.RED, R.drawable.hoa_hong, "Tưới bằng bình chuyên dụng, có vòi hoa sen xung quanh gốc, trnahs tưới vào lá làm nát lá."));
        tempTree.add(new Tree(new LatLng(21.007478, 105.847441), new int[]{R.mipmap.ic_03_do, R.mipmap.ic_03_ca, R.mipmap.ic_03_xa}, "Cải cúc", Tree.GREEN, R.drawable.cai_cuc, "Tưới nhẹ tay từ trên xuống, để nước bao trùm quanh cây"));
        tempTree.add(new Tree(new LatLng(21.006916, 105.842095), new int[]{R.mipmap.ic_04_do, R.mipmap.ic_04_ca, R.mipmap.ic_04_xa}, "Cây bàng", Tree.YELLOW, R.drawable.caybang, "Tưới nhiều vào gốc cây, cần tưới cxung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.007312, 105.843096), new int[]{R.mipmap.ic_05_do, R.mipmap.ic_05_ca, R.mipmap.ic_05_xa}, "Hoa dâm bụt", Tree.GREEN, R.drawable.hoa_dam_but, "Tưới đều xung quanh gốc, chú ý không tưới quá mạnh tay"));
        tempTree.add(new Tree(new LatLng(21.004701, 105.842026), new int[]{R.mipmap.ic_06_do, R.mipmap.ic_06_ca, R.mipmap.ic_06_xa}, "Cây phượng", Tree.RED, R.drawable.cay_phuong, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.003840, 105.841967), new int[]{R.mipmap.ic_07_do, R.mipmap.ic_07_ca, R.mipmap.ic_07_xa}, "Cây đa", Tree.RED, R.drawable.cay_da, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.003700, 105.843545), new int[]{R.mipmap.ic_08_do, R.mipmap.ic_08_ca, R.mipmap.ic_08_xa}, "Cây bưởi", Tree.GREEN, R.drawable.cay_buoi, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.006808, 105.845926), new int[]{R.mipmap.ic_09_do, R.mipmap.ic_08_ca, R.mipmap.ic_09_xa}, "Hoa loa kèn", Tree.RED, R.drawable.hoa_loa_ken, "Tưới nhẹ nhàng, dùng bình tưới chuyên dụng, nhẹ tay tránh để nát hoa."));
        tempTree.add(new Tree(new LatLng(21.005130, 105.846101), new int[]{R.mipmap.ic_10_do, R.mipmap.ic_08_ca, R.mipmap.ic_10_xa}, "Cây chanh", Tree.YELLOW, R.drawable.cay_chanh, "Tưới tập trung vào gốc cây và lá cây, tốt nhất là vào buổi sáng để cây hấp thụ ánh sáng mặt trời."));
        tempTree.add(new Tree(new LatLng(21.011250, 105.844249), new int[]{R.mipmap.ic_11_do, R.mipmap.ic_11_ca, R.mipmap.ic_11_xa}, "Cây gạo", Tree.RED, R.drawable.cay_gao, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.005924, 105.846553), new int[]{R.mipmap.ic_12_do, R.mipmap.ic_12_ca, R.mipmap.ic_12_xa}, "Cây gạo", Tree.YELLOW, R.drawable.cay_gao, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.006298, 105.845296), new int[]{R.mipmap.ic_13_do, R.mipmap.ic_13_ca, R.mipmap.ic_13_xa}, "Cây bàng", Tree.GREEN, R.drawable.caybang, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.008228, 105.841807), new int[]{R.mipmap.ic_14_do, R.mipmap.ic_14_ca, R.mipmap.ic_14_xa}, "Cây phượng", Tree.RED, R.drawable.cay_phuong, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.009360, 105.845306), new int[]{R.mipmap.ic_15_do, R.mipmap.ic_15_ca, R.mipmap.ic_15_xa}, "Hoa hồng", Tree.GREEN, R.drawable.hoa_hong, "Tưới bằng bình chuyên dụng, có vòi hoa sen xung quanh gốc, trnahs tưới vào lá làm nát lá."));
        tempTree.add(new Tree(new LatLng(21.009641, 105.841498), new int[]{R.mipmap.ic_16_do, R.mipmap.ic_16_ca, R.mipmap.ic_16_xa}, "Hoa loa kèn", Tree.YELLOW, R.drawable.hoa_loa_ken, "Tưới nhẹ nhàng, dùng bình tưới chuyên dụng, nhẹ tay tránh để nát hoa."));
        tempTree.add(new Tree(new LatLng(21.009468, 105.841728), new int[]{R.mipmap.ic_17_do, R.mipmap.ic_17_ca, R.mipmap.ic_17_xa}, "Cây đa", Tree.GREEN, R.drawable.cay_da, "Tưới nhiều vào gốc cây, cần tưới xung quanh gốc, tưới vào buổi sáng sáng sớm là tốt nhất."));
        tempTree.add(new Tree(new LatLng(21.010814, 105.842599), new int[]{R.mipmap.ic_18_do, R.mipmap.ic_18_ca, R.mipmap.ic_18_xa}, "Cây chanh", Tree.RED, R.drawable.cay_chanh, "Tưới tập trung vào gốc cây và lá cây, tốt nhất là vào buổi sáng để cây hấp thụ ánh sáng mặt trời."));
        tempTree.add(new Tree(new LatLng(21.006508, 105.842535), new int[]{R.mipmap.ic_18_do, R.mipmap.ic_18_ca, R.mipmap.ic_18_xa}, "Cải cúc", Tree.YELLOW, R.drawable.cai_cuc, "Tưới nhẹ tay từ trên xuống, để nước bao trùm quanh cây"));
...
//                break;
    ...
    public void onMarkerDragEnd(Marker marker) {
        if (marker.getTitle() != null && marker.getTitle().equals(MARKKER_CURRENT_POSITION)) {
            ...
            Tree tree = null;
            for (StopOver stopOver : tour) {
                if (stopOver instanceof Tree) {
                    tree = (Tree) stopOver;
                }
            }
            if (tree != null) {
                Intent intent = new Intent(this, SprayTreeActivity.class);
                intent.putExtra(TREE, tree);
                startActivityForResult(intent, REQUEST_TREE_SPRAY_ACT);
            }
        }
    }
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == REQUEST_TREE_SPRAY_ACT) {
            if (resultCode == Activity.RESULT_OK) {
                Tree tree = data.getParcelableExtra("result");
//                Log.e("MY_TAG", "REQUEST_TREE: " + tree.getId());
                for (Marker marker : markers.values()) {
                    if (marker.getTag() instanceof Tree && ((Tree) marker.getTag()).getId().equals(tree.getId())) {
//                        Log.e("MY_TAG", "REQUEST_TREE_SPRAY_ACT: " + ((Tree) marker.getTag()).getId());
                        marker.setIcon(BitmapDescriptorFactory.fromResource(tree.getIcon()));
                    }
                }
            }
        }
